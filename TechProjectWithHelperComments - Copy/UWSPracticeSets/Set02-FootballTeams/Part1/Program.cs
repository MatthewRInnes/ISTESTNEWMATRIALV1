...
using Set02.FootballTeams.Part1;
...
const string databaseFileName = "FootballTeams.db";
const string sqlFileName = "FootballTeams.sql";
...
Console.Write("Enter a FootballTeams name to search for: ");
