...
public class IndexModel : PageModel
{
    ...
    private readonly NewsSitesDbContext _db;

    // Constructor receives the registered DbContext from dependency injection.
    public IndexModel(NewsSitesDbContext db)
    {
    ...
    public List<NewsSite> NewsSites { get; private set; } = [];
