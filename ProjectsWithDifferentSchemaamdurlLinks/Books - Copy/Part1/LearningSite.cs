...
public class Book
{
    ...
    [Required]
    // This must match the SQL column name in Books.sql: `Title TEXT NOT NULL`.
    [Column("Title")]
    // Student's Full name (used for searching and display).
    public string Title { get; set; } = string.Empty;

    // This must match the SQL column name in Books.sql: `Author TEXT NOT NULL`.
    [Column("Author")]
    ...
    [Required]
    // Maps to the SQL column holding the Amazon link.
    [Column("AmazonURL")]
