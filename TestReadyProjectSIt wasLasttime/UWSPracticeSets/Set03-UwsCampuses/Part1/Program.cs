...
const string databaseFileName = "UwsCampuses.db";
const string sqlFileName = "UwsCampuses.sql";
...
Console.Write("Enter a UwsCampuses name to search for: ");
