...
using Set06.LibraryResources.Part1;
...
const string databaseFileName = "LibraryResources.db";
const string sqlFileName = "LibraryResources.sql";
...
Console.Write("Enter a LibraryResources name to search for: ");
